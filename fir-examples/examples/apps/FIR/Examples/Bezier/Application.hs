...
module FIR.Examples.Bezier.Application ( bezier ) where
...
-- fir-examples
import FIR.Examples.Bezier.Shaders
...
bezierInitialState :: RenderState
bezierInitialState = initialState { observer = bezierInitialObserver }
...
bezier :: IO ()
bezier = runVulkan bezierInitialState do
  ...
  -- Create framebuffer attachments.
    ...
    let
      ...
      resourceFlags = ResourceSet
        ( StageFlags
          (   Vulkan.SHADER_STAGE_GEOMETRY_BIT
