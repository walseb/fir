...
module FIR.Examples.FullPipeline.Shaders where
...
vertPath = shaderDir </> "fullpipeline_vert.spv"
tescPath = shaderDir </> "fullpipeline_tesc.spv"
tesePath = shaderDir </> "fullpipeline_tese.spv"
geomPath = shaderDir </> "fullpipeline_geom.spv"
fragPath = shaderDir </> "fullpipeline_frag.spv"
...
compileGeometryShader = compileTo geomPath [SPIRV $ Version 1 0] geometry
