...
villarceauNormal :: Float -> Float -> Float -> V 3 Float
...
villarceauCircles
  ...
  -> [Struct RawVertexInput]
villarceauCircles c a circleThickening n grad
  = [ villarceauCircle c a circleThickening theta col
    | k <- [0 .. (n-1)]
...
blueGradient :: Array 3 (V 4 Float)
blueGradient = mkArray . Array.fromList $ fmap (fmap (\n -> n / 255))
  [ V4 138 43  226 255
  , V4 30  144 255 255
  , V4 138 43  226 255
  ]
