...
instance ScalarTy a => PrimOp SPIRV.CrossV (V 3 a) where
  type PrimOpConstraint SPIRV.CrossV (V 3 a) = Floating a
  type PrimOpType SPIRV.CrossV (V 3 a) = V 3 a -> V 3 a -> V 3 a
  op = cross
